...
urlpatterns = [
    ...
    # path('form/form-test', views.FileFieldFormView.as_view(), name='form-test'),
    # Tables
    path('infomation/maps',views.BasicTableView.as_view(),name='tables-basic'), # Tables-Basic
    path('infomation/tasks',views.DatatableView.as_view(),name='tables-datatable'), # Tables-Datatable
    path('infomation/forklifts',views.EditableView.as_view(),name='tables-editable'), # Tables-Editable
    ...
    # Test
    path('forms/form-test', views.add_user_image, name='form-test'),
    path('forms/upload_handle', views.upload_handle, name='upload_handle'),
