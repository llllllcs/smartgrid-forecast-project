...
class BasicTableView(LoginRequiredMixin,View):
    def get(self,request):
        greeting={}
        greeting['title'] = "路径信息管理"
        greeting['pageview'] = "信息管理"
        return render(request,'components/tables/tables-editable - grid.html',greeting)

# Datatables
class DatatableView(LoginRequiredMixin,View):
    def get(self,request):
        greeting={}
        greeting['title'] = "货物信息管理"
        greeting['pageview'] = "信息管理"
        return render(request,'components/tables/tables-editable - task.html',greeting)
...
class EditableView(LoginRequiredMixin,View):
    def get(self, request):
        greeting={}
        greeting['title'] = "AGV信息管理"
        greeting['pageview'] = "信息管理"
        return render(request,'components/tables/tables-editable - agv.html',greeting)
...
"""class FileFieldFormView(FormView):
    ...
    template_name = "components/tables/tables-editable - agv.html"  # Replace with your template.
    success_url = "/components/forms/form-file-upload"
...
def add_user_image(request):
    return render(request, 'components/tables/tables-editable - agv.html')


def upload_handle(request):
    files = request.FILES['file']
    where = '%s/test/%s' % (settings.MEDIA_ROOT, files.name)
    content = files.chunks()
